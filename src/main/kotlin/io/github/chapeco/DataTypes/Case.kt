...
(
        ...
        @Transient val createdOn: Timestamp? = null,
        @SerialName("created_on") private val createdOnActual: Long? = createdOn.toString().toLongOrNull(),
        ...
        @Transient val updatedOn: Timestamp? = null,
        @SerialName("updated_on") private val updatedOnActual: Long? = updatedOn.toString().toLongOrNull(),
