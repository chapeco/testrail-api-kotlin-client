...
class RunTest
{
    ...
    fun instantiateRunTest()
    {
        ...
        Assert.assertEquals(expectedRun.toString(),actualRun.toString())
    }
    ...
    fun serializeRunTest()
    {
        ...
        Assert.assertEquals(expectedRun,JSON.unquoted.stringify(actualRun))
    }
    ...
    fun getRunTest()
    {
        ...
        println(JSON.unquoted.stringify(actualRun))
        Assert.assertEquals(expectedRun,actualRun)
    }
    ...
    fun getRunsTest()
    {
        ...
        Assert.assertEquals(expectedRunsList,actualRunsList)
    }
